...
{`          ___
      ...
      <div style={{ fontFamily: 'var(--nl-font-sans)', fontSize: 16, lineHeight: 1.7, color: 'var(--nl-fg-1)' }}>
        ...
        <ul style={{ paddingLeft: 22 }}>
          <li><a href="mailto:mail@hexops.online" style={link}>mail</a> — encrypt if you like (<a href="https://keys.openpgp.org/vks/v1/by-fingerprint/0BDF7EBFB38BF69D9531F7E6CD44CE2DA84B5813" target="_blank" rel="noopener noreferrer" style={{ ...inlineCode, ...link, borderBottom: '1px solid var(--nl-accent-line)' }}>0BDF7E…B5813</a>)</li>

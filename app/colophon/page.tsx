...
{`          ___
      ...
      <div style={{ fontFamily: 'var(--nl-font-sans)', fontSize: 16, lineHeight: 1.7, color: 'var(--nl-fg-1)' }}>
        ...
        <ul style={{ paddingLeft: 22 }}>
          <li><a href="#" style={link}>mail</a> — encrypt if you like (<code style={inlineCode}>0xBEEF...</code>)</li>
          <li style={{ marginTop: 6 }}><a href="#" style={link}>mastodon</a> · <a href="#" style={link}>github</a></li>
        </ul>
      </div>
    </div>
  )
